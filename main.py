def get_number_of_teams():
    while True:
        num_teams = int(input("Enter the number of teams in tournament: "))
        if num_teams >= 2:
            break
        else:
...
games_played = get_number_of_games(num_teams)
team_wins = get_number_of_wins(team_names, games_played)

print("Generating the games to be played in the first round of tournament....")
